...
_gettext('Started watching this repository');
...
_gettext('{0} ({1} inactive) of {2} user groups ({3} inactive)');
_gettext('{0} ({1} inactive) of {2} users ({3} inactive)');
