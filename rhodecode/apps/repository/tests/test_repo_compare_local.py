...
class TestCompareView(object):
    ...
    def test_compare_tag(self, backend):
        ...
        response = self.app.get(
            route_path(
                ...
                source_ref_type="tag", source_ref=tag1,
    ...
    def test_compare_commits(self, backend):
        ...
        commit1_short_id = commit1.short_id
        commit2 = repo.get_commit(commit_idx=1)
        commit2_short_id = commit2.short_id
        ...
        anchor = 'a_c-{}-c8e92ef85cd1'.format(commit2_short_id)
