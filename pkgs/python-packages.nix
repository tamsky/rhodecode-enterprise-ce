...
self: super: {
  ...
  "bottle" = super.buildPythonPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "0m9k2a7yxvggc4kw8fsvj381vgsvfcdshg5nzy6vwrxiw2p53drr";
    };
    meta = {
      license = [ pkgs.lib.licenses.mit ];
    };
  ...
  "dogpile.cache" = super.buildPythonPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "0cazkfz4zhywh7ahahivwjdbqdjpqij65a6hjc7bnwa4igkrf4b3";
    };
    meta = {
      license = [ pkgs.lib.licenses.bsdOriginal ];
    };
  ...
  "psutil" = super.buildPythonPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "1zlw91g1zh5mr55ixkxvz8bqps4naiik2lgwvrfbj95v6sz97qpb";
    };
    meta = {
      license = [ pkgs.lib.licenses.bsdOriginal ];
    };
